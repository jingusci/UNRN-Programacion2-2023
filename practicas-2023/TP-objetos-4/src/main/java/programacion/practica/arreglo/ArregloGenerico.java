...
public class ArregloGenerico<T extends Comparable<T>>{
     ...
     */
    public ArregloGenerico(int largoInicial) {
     ...
     *
     * @param posicion la ubicacion cuyo valor sera reemplazada.
     * @param valor lo que reemplazara en la ubicacion indicada.
     */
     ...
     * @param valor el valor del elemento a insertar
     */
    public void insertarEnOrdenAscendente(T valor) {
        throw new RuntimeException("Implementar");
    }
